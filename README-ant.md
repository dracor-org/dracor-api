# `ant` Workflow for dracor-api

*This is the documentation of the `ant` based development workflow for the
`dracor-api` eXistdb package. We recommend using
[docker-compose](README.md#Getting-Started) instead.*
